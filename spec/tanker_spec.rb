...
describe Tanker do
  ...
  describe ".tankit" do
    ...
    it 'should require an index name when setting up tanker model' do
      Tanker.configuration = {:url => 'http://api.indextank.com'}
      @dummy_class.send(:include, Tanker)
      lambda {
        @dummy_class.send(:tankit) {}
      }.should raise_error(Tanker::NoIndexName)
    end

    it 'should attempt to guess an index name when seting up tanker model' do
      Tanker.configuration = {:url => 'http://api.indextank.com'}
      @dummy_class.send(:include, Tanker)
      ...
      @dummy_class.tanker_config.index_name.should == 'myapp_my_env'
